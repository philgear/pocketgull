...
```mermaid
gantt
    title Pocket Gull Release Milestone Evolution (v1.0.0-rc1 -> v1.0.0-rc10)
    ...
    section Telemetry & Icon Standardization
    v1.0.0-rc9 (3D Search, CMP Panels & Global Languages)  :done, rc9, 2026-07-17, 2026-07-21
    v1.0.0-rc10 (PhysioNet Lens, Origami & Box-Breat):active, rc10, 2026-07-21, 3d
```
