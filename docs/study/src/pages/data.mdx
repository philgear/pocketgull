...
### FHIR Bundles
Patient data is exportable as standard <DocNode term="FHIR R6" category="HL7 International" hint="Fast Healthcare Interoperability Resources Release 6 — the next-generation HL7 standard for electronic health data exchange, adding specialized EBM and AI attribution models." link="http://hl7.org/fhir/R6/" linkLabel="HL7 FHIR R6 →" icon="https://hl7.org/favicon.ico">**FHIR R6 JSON Bundles**</DocNode>, Unicode-safe and Base64-encoded. This ensures open data portability across any FHIR-compliant healthcare system.

### FHIR Import
The Import Service accepts FHIR payloads — including **Epic/MyChart "Lucy" format** and upgraded FHIR R6 datasets — mapping external `DiagnosticReport`, `Observation`, `Condition`, `Device` (AI engine credentials), and `Evidence` (PubMed evidence trails) resources into Pocket Gull's native models.
...
| **Export formats** | FHIR R6 Bundle (JSON), PDF |
| **Import formats** | FHIR R6, FHIR R4, Epic/Lucy |
