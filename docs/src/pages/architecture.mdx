...
| `/api/ai/chat/message` | Handles multimodal arrays, lifting standard limits to `50mb` to decode Base64 Image/PDF lab reports into `inlineData` for native Vertex AI Vision processing. |
