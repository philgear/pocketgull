...
Every clinical action — from patient data modifications to AI inference requests — is asynchronously logged to a centralized, tampering-resistant <DocNode term="BigQuery" category="Google Cloud" hint="Serverless, highly scalable enterprise data warehouse." link="https://cloud.google.com/bigquery/docs" linkLabel="BigQuery Docs →" icon="https://www.gstatic.com/devrel-devsite/prod/v0e0f589edd85502a40d78d7d0825db8ea5ef3b99ab4070381571c97ab7df9861/cloud/images/favicons/onecloud/favicon.ico">BigQuery</DocNode> ledger. This establishes an indisputable chain of custody, ensuring that practitioner oversight over AI systems is verifiable during compliance and medical audits.
...
Data transmitted to the <DocNode term="Vertex API" category="Google Cloud" hint="Enterprise AI API ensuring strict data residency." link="https://cloud.google.com/vertex-ai" linkLabel="Vertex API →" icon="https://www.gstatic.com/devrel-devsite/prod/v0e0f589edd85502a40d78d7d0825db8ea5ef3b99ab4070381571c97ab7df9861/cloud/images/favicons/onecloud/favicon.ico">Vertex AI API</DocNode> for inference is restricted by HIPAA-compliant Business Associate Agreements (BAAs), used solely for generating the immediate clinical response, and explicitly excluded from underlying foundation model training.
