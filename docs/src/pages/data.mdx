...
- **Local Persistence** — All patient states, clinical brackets, and historical visit notes are stored strictly within the client's local browser session powered by the native asynchronous **IndexedDB** cache architecture.
