...
class ClinicalIntelligenceService {
  ...
  /// ACM §1.2 / IEEE SWEBOK Professional Practice: AI-generated clinical content
  /// must be presented as decision-support only and never as a substitute for
  /// qualified professional medical judgment.
  static const String _clinicalDisclaimer =
      '> ⚕️ **Clinical Decision Support Notice** (ACM §1.2): The following analysis is '
      'generated by an AI model and is intended solely as a decision-support tool for '
      'qualified clinicians. It does not constitute medical advice, a diagnosis, or a '
      'treatment recommendation. Always apply independent clinical judgment.\n\n---\n\n';

  ClinicalIntelligenceService({
    required String apiKey,
    String? proxyBaseUrl,
  })  : _proxyBaseUrl = proxyBaseUrl ??
            // Item #2: URL injected via --dart-define=CLOUD_RUN_URL for env safety (ACM §2.9)
  ...
  Stream<String> generateReportStream(String patientData, AnalysisLens lens, {OrcidProfile? orcidProfile}) async* {
    ...
    if (_proxyBaseUrl.isNotEmpty) {
      ...
      if (response.statusCode == 200) {
        // Item #3: Emit ACM-aligned AI disclaimer before clinical content (ACM §1.2 Avoid Harm)
        yield _clinicalDisclaimer;
    ...
    // Item #3: Emit disclaimer before streaming
    yield _clinicalDisclaimer;
