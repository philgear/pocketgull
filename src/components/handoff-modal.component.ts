          ...
          <div class="p-6 overflow-y-auto space-y-6 flex-1">
            ...
            <div class="p-4 rounded-xl border border-slate-200 dark:border-zinc-800 bg-slate-50/50 dark:bg-zinc-950/40 space-y-3">
              ...
              <div class="text-xs font-sans space-y-2 text-slate-700 dark:text-zinc-300">
                ...
                <p><strong>[BACKGROUND]</strong> Primary complaint: <em>{{ patientState.currentSymptoms() || 'Complex Multi-System Assessment' }}</em> across {{ issueCount() }} anatomical region(s).</p>
...
Primary Complaint: ${this.patientState.currentSymptoms() || 'Complex Multi-System Assessment'}
