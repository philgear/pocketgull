  ...
  template: `    
    <div class="flex flex-col h-full w-full bg-white/70 dark:bg-zinc-900 backdrop-blur-[12px] text-gray-900 dark:text-zinc-100 rounded-2xl overflow-hidden border border-gray-200 dark:border-zinc-800 shadow-xl font-sans relative">
      ...
      <div class="py-2.5 px-4 bg-slate-100/90 dark:bg-zinc-950/90 border-b border-gray-200 dark:border-zinc-800/80 flex items-center gap-2 overflow-x-auto text-xs z-20 hide-scrollbar">
        ...
        } @else if (themeService.currentTheme() === 'curie') {
          <span class="text-xs font-black uppercase tracking-wider text-emerald-400 shrink-0 mr-1">⚛️ Curie Radium Lab:</span>
          <button (click)="select('chest', 'Radium-226 Hematopoietic Niche')" class="min-h-[44px] px-3.5 py-2 rounded-lg bg-emerald-950/90 text-emerald-300 border border-emerald-500/60 hover:bg-emerald-900 transition-all text-xs font-bold shrink-0 cursor-pointer flex items-center gap-1.5 shadow-xs">⚛️ Radium-226 Marrow (Chest)</button>
          <button (click)="select('r_hand', 'Right Hand Dermatitis Lesion')" class="min-h-[44px] px-3.5 py-2 rounded-lg bg-amber-950/90 text-amber-300 border border-amber-500/60 hover:bg-amber-900 transition-all text-xs font-bold shrink-0 cursor-pointer flex items-center gap-1.5 shadow-xs">☢️ Palmar Dermatitis (Right Hand)</button>
          <button (click)="select('l_hand', 'Polonium Dermal Erythema')" class="min-h-[44px] px-3.5 py-2 rounded-lg bg-amber-950/90 text-amber-300 border border-amber-500/60 hover:bg-amber-900 transition-all text-xs font-bold shrink-0 cursor-pointer flex items-center gap-1.5 shadow-xs">🧪 Polonium Erythema (Left Hand)</button>
          <button (click)="select('head', 'Cranial Radium Shielding')" class="min-h-[44px] px-3.5 py-2 rounded-lg bg-cyan-950/90 text-cyan-300 border border-cyan-500/60 hover:bg-cyan-900 transition-all text-xs font-bold shrink-0 cursor-pointer flex items-center gap-1.5 shadow-xs">🛡️ Cranial Lead Shielding</button>
        }
      </div>
